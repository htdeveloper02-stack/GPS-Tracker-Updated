...
import gps.trackerid.location.databinding.LayoutIntro1Binding;
import gps.trackerid.location.databinding.LayoutIntro2Binding;
import gps.trackerid.location.ui.baseui.BaseFragment;

public class OnBoardFragment2 extends BaseFragment {

    private LayoutIntro2Binding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = LayoutIntro2Binding.inflate(inflater, container, false);
